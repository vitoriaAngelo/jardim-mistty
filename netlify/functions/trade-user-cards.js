...
exports.handler=async event=>{
  ...
  try{
    ...
    const gardenResponse=await fetch(SUPABASE_URL+'/rest/v1/gardens?username=eq.'+encodeURIComponent(username)+'&select=data,updated_at&order=updated_at.desc&limit=1',{headers:{apikey:KEY,Authorization:'Bearer '+KEY}});
