(() => {
  ...
  function renderRewards(){
    ...
    const rewards=[
      ...
      ['mascot','Brotinho Arco-Íris','+1 rega em uma planta que precise de água, aleatória, a cada 5 segundos sem gastar o regador. Há 0,01% de chance por ciclo de regar todas as que precisam de água e 1% de chance de colher uma planta pronta para o Mercado.','Complete as 10 figurinhas Arco-Íris.','Usar Brotinho']
    ];
